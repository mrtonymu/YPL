...
(function($) {
    ...
    wpwMsg={
        single:function (msg) {
            ...
            setTimeout(function(){
                ...
                $(globalwpw.settings.messageLastChild+' .wp-chatbot-paragraph').html("<span class=\"wpb-text\">"+msg+"</span>");
        ...
        single_custom2:function (array) {
           // console.log(array);
            ...
            setTimeout(function(){
               ...
               jQuery.each(array, function(i, msg){
                  // console.log(msg);
                   var matches = msg.match(/(https?:\/\/.*\.(?:png|jpg|gif|jpeg|tiff))/i);
                   matches = wpwKits.removeDups(matches);
                   if(Array.isArray(matches)){
                ...
                $(globalwpw.settings.messageLastChild+' .wp-chatbot-paragraph').parent().addClass('wp-chatbot-msg-flat2').find('.wp-chatbot-paragraph').html(html);
                //If has youtube link then show video
                wpwKits.videohandler();
                //scroll to the last message
                wpwKits.scrollTo();
        ...
        double:function (fristMsg,secondMsg) {
            ...
            setTimeout(function(){
                ...
                $(globalwpw.settings.messageLastChild+' .wp-chatbot-paragraph').html("<span class=\"wpb-text\">"+fristMsg+"</span>");
                wpwKits.videohandler();
                ...
                setTimeout(function(){
                    ...
                    $(globalwpw.settings.messageLastChild+' .wp-chatbot-paragraph').html("<span class=\"wpb-text\">"+secondMsg+"</span>");
                    //Scroll to the last message
                    wpwKits.scrollTo();
                    wpwKits.videohandler();
                    //Enable the editor
            ...
            setTimeout(function(){
                ...
                setTimeout(function(){
                    ...
                    setTimeout(function(){
                        ...
                        $(globalwpw.settings.messageLastChild+' .wp-chatbot-paragraph').html("<span class=\"wpb-text\">"+thirdMsg+"</span>");
                        //Scroll to the last message
                        wpwKits.scrollTo();
                        wpwKits.videohandler();
                        //Enable the editor
    ...
    wpwKits={
            ...
            if(localStorage.getItem('botsessionid')){
                ...
                if(globalwpw.settings.obj.is_chat_session_active){
                    wpwKits.ajax(data).done(function (response) {
                        ...
                        // $('.wpbot_carousel_wraper').not('.slick-initialized').slick(globalwpw.slick_settings);
                    })
                }
        ...
        shopperMsgDom:function (msg) {
            ...
            var msgContent='<li class="wp-chat-user-msg">' +
                ...
                +'<div class="wp-chatbot-paragraph"><span class="wpb-text">'+msg+'</span></div></li>';
            return msgContent;
        },
        showCart:function () {
            ...
            this.ajax(data).done(function (response) {
                ...
                if($('#wp-chatbot-shortcode-template-container').length > 0  && $('.chatbot-shortcode-template-02').length==0) {
                    $('.wp-chatbot-cart-body').slimScroll({height: '200px', start: 'bottom', wheelStep: 3});
                }
            });
        },
            ...
            if(globalwpw.settings.obj.ai_df_enable==1 && globalwpw.df_status_lock==0){
                ...
                //When user asking needs then DialogFlow will given intent after NLP steps.
                    ...
                    dfReturns.done(function( response ) {
                        ...
                        //             var index=0;
                        //             var html = '<h2 class="glossary-title">IN GENERAL</h2>';
                        //             for(index; index<globalwpw.settings.obj.help_msg_custom.length; index++){
                        //                html += "<span class=\"wpb-quick-reply qcld-chat-common\">"+globalwpw.settings.obj.help_msg_custom[index].icbot_glossary_bot+"</span>";
                        //             }
                        //             var index=0;
                        //             html += '<h2 class="glossary-title">FOR DELEGATES</h2>';
                        //             for(index; index<globalwpw.settings.obj.help_msg_custom_delegates.length; index++){
                        //                html += "<span class=\"wpb-quick-reply qcld-chat-common\">"+globalwpw.settings.obj.help_msg_custom_delegates[index].icbot_glossary_bot+"</span>";
                        //             }
                        //             var index=0;
                        //             html += '<h2 class="glossary-title">FOR SPONSORS</h2>';
                        //             for(index; index<globalwpw.settings.obj.help_msg_custom_sponsor.length; index++){
                        //                html += "<span class=\"wpb-quick-reply qcld-chat-common\">"+globalwpw.settings.obj.help_msg_custom_sponsor[index].icbot_glossary_bot+"</span>";
                        //             }
                        //             var index=0;
                        //             html += '<h2 class="glossary-title">FOR PRESENTERS</h2>';
                        //             for(index; index<globalwpw.settings.obj.help_msg_custom_presenter.length; index++){
                        //                html += "<span class=\"wpb-quick-reply qcld-chat-common\">"+globalwpw.settings.obj.help_msg_custom_presenter[index].icbot_glossary_bot+"</span>";
                        //             }
                        //             wpwMsg.double_nobg('Pick a question!',html);
                        //             //dialogflow
                        //             if(globalwpw.settings.obj.ai_df_enable==1 && globalwpw.df_status_lock==0){
                        //                 globalwpw.wildCard=0;
                        //                 globalwpw.ai_step=1;
            ...
            if(globalwpw.settings.obj.df_api_version=='v1'){
                ...
                jQuery.each( messages, function( key, message ) {
                    ...
                    //handleing default response
                        ...
                        html +='<div class="wpbot_image_wraper">';
                            html+='<div class="wpbot_card_image">';
                                if(typeof message.image.imageUri !=="undefined" && message.image.imageUri!=''){
                       ...
                       if(typeof message.payload.thumbnail_quickreply !=="undefined"){
                       ...
                       else if(typeof message.payload.carousel !=="undefined"){
                          var index = 0;
                          html +='<div class="wpbot_carousel_wraper">';
                          for (index; index<message.payload.carousel.length; index++) {
                             if(message.payload.carousel[index].url !=="undefined" && message.payload.carousel[index].url!=''){
                                html +='<a href="'+message.payload.carousel[index].url+'" target="_blank">';
                             }
                                 html+='<div class="wpbot_carousel_item">';
                                     if(message.payload.carousel[index].image !=="undefined" && message.payload.carousel[index].image!=''){
                                         html+='<img src="'+message.payload.carousel[index].image+'" />';
                                     }
                                 html+='</div>';
                              if(message.payload.carousel[index].url !=="undefined" && message.payload.carousel[index].url!=''){
                                 html +='</a>';
                       ...
                       else if(typeof message.payload.multi_cards !=="undefined"){
                          var index = 0;
                          html +='<div class="wpbot_multicards_wraper">';
                          for (index; index<message.payload.multi_cards.length; index++) {
                             html +='<div class="wpbot_card_wraper">';
                             if(message.payload.multi_cards[index].url !=="undefined" && message.payload.multi_cards[index].url!=''){
                                html +='<a href="'+message.payload.multi_cards[index].url+'" target="_blank">';
                             }
                                 html+='<div class="wpbot_card_image">';
                                     if(message.payload.multi_cards[index].image !=="undefined" && message.payload.multi_cards[index].image!=''){
                                         html+='<img src="'+message.payload.multi_cards[index].image+'" />';
                                     }

                                     html+='<div class="wpbot_card_caption">';
                                     if(typeof message.payload.multi_cards[index].text !=="undefined" && message.payload.multi_cards[index].text !=""){
                                         html+='<h2>'+message.payload.multi_cards[index].text+'</h2>';
                                     }
                                     html+='</div>';
                                 html+='</div>';
                              if(message.payload.multi_cards[index].url !=="undefined" && message.payload.multi_cards[index].url!=''){
                       ...
                       else if(typeof message.payload.custom_quickreply !=="undefined"){
                          var index = 0;
                          html += "<div class=\"wpb-quick-reply-wrapper\">";

                          for (index; index<message.payload.custom_quickreply.length; index++) {
                             html += "<span class=\"wpb-quick-reply qcld-chat-common\">"+ message.payload.custom_quickreply[index].text +"</span>";
                          }
                          html += "</div>";
                       }

                       else if(typeof message.payload.custom_quickreply_with_link !=="undefined"){
                          var index = 0;
                          html += "<div class=\"wpb-quick-reply-wrapper\">";
                          for (index; index<message.payload.custom_quickreply_with_link.length; index++) {
                             html += "<a href='"+message.payload.custom_quickreply_with_link[index].url+"' target=\"_blank\" class=\"wpb-quick-reply-with-link qcld-chat-common\">"+ message.payload.custom_quickreply_with_link[index].text +"</a>";
                          }
                          html += "</div>";
                       }

                       else if(typeof message.payload.live_agent_yes !=="undefined"){
                          if(globalwpw.settings.obj.is_livechat_active){
          						// if(globalwpw.settings.obj.disable_livechat_operator_offline==1){
          						// 	if(globalwpw.settings.obj.is_operator_online==1){
                           //       html += "<span class=\"wpb-text\">One moment, please. My colleague will be with you shortly.</span>";
                           //
                           //       setTimeout(function () {
                           ...
                           //
          						// 	} else{
                           //       html += "<span class=\"wpb-text\">Oh no! You just missed our working hours. How about <a href=\"#\" class=\"qcld-chatbot-suggest-email\">leaving your contact details</a> and we’ll get back to you soonest possible?</span>";
                           //    }
          						// }else{
          						// 	html += "<span class=\"wpb-text\">Oh no! You just missed our working hours. How about <a href=\"#\" class=\"qcld-chatbot-suggest-email\">leaving your contact details</a> and we’ll get back to you soonest possible?</span>";
          						// }

                           if(globalwpw.settings.obj.agent_working){
                              html += "<span class=\"wpb-text\">One moment, please.</span>";
                              ...
                              setTimeout(function () {
                                 ...
                                 if(!$('#wp-live-editor').data('clientid')) {
                                    $("#wp-chatbot-board-container").removeClass('active-chat-board');
             								$('.wp-chatbot-container').hide();
             								$('.wpbot-saas-live-chat').show();
                                 } else {
                                    $('#wp-chatbot-editor-container .input-bot').hide();
             								$('#wp-chatbot-editor-container .input-live').show();
                          ...
                          // if(globalwpw.settings.obj.is_livechat_active) {
                          //    console.log(globalwpw.settings.obj.is_operator_online);
                          //    if(globalwpw.settings.obj.is_operator_online==1){
                          //       html += "<span class=\"wpb-text\">One moment, please. My colleague will be with you shortly.</span>";
                          //
                          //        if($('#wbca_signup_fullname').length>0){
        ...
        support:function (msg) {
            if(globalwpw.wildCard==1 && globalwpw.supportStep=='welcome'){
                ...
                if(globalwpw.settings.obj.support_query.length>0){
                    ...
                    // console.log(globalwpw.settings.obj.ic_bot_main_menu);

                    $.each(globalwpw.settings.obj.ic_bot_main_menu, function (i, obj) {
                       supportsItems += '<span class="qcld-chatbot-support-items"  data-query-index="' + i + '">' + obj.main_menu_text + '</span>';
                    });
         ...
         //console.log(globalwpw.settings.obj.form_commands, allformname, globalwpw.settings.obj.form_ids);
            ...
            if(globalwpw.wildcardsHelp.indexOf(msg.toLowerCase())>-1){
                ...
                if(globalwpw.wildCard==1){
                   var botJoinMsg="Hello, I am <strong>"+globalwpw.settings.obj.agent+" </strong>! How can I help you today?";
      				   wpwMsg.single(botJoinMsg);
                     setTimeout(function(){
                         wpwTree.support(msg);
                     },globalwpw.settings.preLoadingTime)
    ...
    $.wpwbot = function(options) {
            ...
            wpwKits.ajax(data).done(function (response) {
                ...
                if($('#wp-chatbot-shortcode-template-container').length > 0){
                    ...
                    wpwKits.ajax(data).done(function (response) {
                        ...
                        $('.chatbot-sidebar .wp-chatbot-products').slimScroll({height: '435px', start: 'top', wheelStep: 3});
                    });
                }
            });
      ...
      $(document).on('click', '.wpb-quick-reply2', function(e){
			e.preventDefault();
			$('#wp-chatbot-editor').val($(this).find('.wpb-quick-reply').html());
			$('#wp-chatbot-send-message').trigger( "click" );
		})
        ...
        $(document).on('click','.qcld-chatbot-support-items',function (e) {
            ...
            var support_answer = globalwpw.settings.obj.ic_bot_main_menu[queryIndex];
            // console.log(support_answer);
            if(support_answer.is_sub_cat) {
               var index = 0;
               var html = "<div class=\"wpb-quick-reply-wrapper\">";
               for (index; index<support_answer.intent.length; index++) {
                  html += "<span class=\"wpb-quick-reply qcld-chat-common\">"+ support_answer.intent[index].text +"</span>";
               }
               html += "</div>";
               wpwMsg.single_custom(html);
            } else {
               var html = '<span class="wpb-text">'+support_answer.answer+'</span>';
               html += '<div class="wpb-quick-reply-wrapper"><span class="wpb-quick-reply qcld-chat-common">Return To Main Menu</span></div>';
               wpwMsg.single_custom(html);
            ...
            //    var index = 0;
            //    var html = "<div class=\"wpb-quick-reply-wrapper\">";
            //    for (index; index<globalwpw.settings.obj.icbot_faq_general.length; index++) {
            //       html += "<span class=\"wpb-quick-reply qcld-chat-common\">"+ globalwpw.settings.obj.icbot_faq_general[index].icbot_glossary_bot +"</span>";
            //    }
            //    html += "</div>";
            //    wpwMsg.single_custom(html);
            // } else if (queryIndex == 1){
            //    wpwMsg.single(globalwpw.settings.obj.icbot_faq_admissions);
            // } else if (queryIndex == 2){
            //    var index = 0;
            //    var html = "<div class=\"wpb-quick-reply-wrapper\">";
            //    for (index; index<globalwpw.settings.obj.icbot_faq_support.length; index++) {
            //       html += "<span class=\"wpb-quick-reply qcld-chat-common\">"+ globalwpw.settings.obj.icbot_faq_support[index].icbot_glossary_bot +"</span>";
            //    }
            //    html += "</div>";
            //    wpwMsg.single_custom(html);
            ...
            //    var index = 0;
            //    var html = "<div class=\"wpb-quick-reply-wrapper\">";
            //    for (index; index<globalwpw.settings.obj.icbot_faq_kidney.length; index++) {
            //       html += "<span class=\"wpb-quick-reply qcld-chat-common\">"+ globalwpw.settings.obj.icbot_faq_kidney[index].icbot_glossary_bot +"</span>";
            //    }
            //    html += "</div>";
            //    wpwMsg.single_custom(html);
            ...
            //    var index = 0;
            //    var html = "<div class=\"wpb-quick-reply-wrapper\">";
            //    for (index; index<globalwpw.settings.obj.ic_faq_knowing.length; index++) {
            //       html += "<span class=\"wpb-quick-reply qcld-chat-common\">"+ globalwpw.settings.obj.ic_faq_knowing[index].icbot_glossary_bot +"</span>";
            //    }
            //    html += "</div>";
            //    wpwMsg.single_custom(html);
            ...
            //    var index = 0;
            //    var html = "<div class=\"wpb-quick-reply-wrapper\">";
            //    for (index; index<globalwpw.settings.obj.ic_faq_patient.length; index++) {
            //       html += "<span class=\"wpb-quick-reply qcld-chat-common\">"+ globalwpw.settings.obj.ic_faq_patient[index].icbot_glossary_bot +"</span>";
            //    }
            //    html += "</div>";
            //    wpwMsg.single_custom(html);
            // }
